  ...
  <ul>
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <tbody>
              <c:forEach items="${shoppinggoods}" var="node">
            
	
            <tr>
             <td><input type="checkbox" /></td>
                <td><input type="text" class="am-form-field am-radius am-input-sm" name="goodsId" value="${node.goodsId}"/></td>
            		<td>${node.goodsId}</td>
            		 <td><a href="#">${node.goodsName}</a></td>
            		
            		 <td>${node.goodsPrice}</td>  
            	...
            	<td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a class="am-btn am-btn-default am-btn-xs am-text-success am-round"><span class="am-icon-search"></span> </a>
                       <button type="button" class="am-btn am-btn-default am-btn-xs am-text-warning  am-round"   data-am-modal="{target: '#my-popups-add'}"> <span class="am-icon-pencil-square-o"></span></button>
                      <!-- <a class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" data-am-modal="{target: '#my-popups-add'}" ><span class="am-icon-pencil-square-o"></span></a> -->
                      <a class="am-btn am-btn-default am-btn-xs am-text-warning  am-round"><span class="am-icon-copy"></span></a>
                      <a class="am-btn am-btn-default am-btn-xs am-text-danger am-round" href="deletegoods?goodsId=${node.goodsId}"><span class="am-icon-trash-o" ></span></a>
                    </div>
                  </div></td>
      ...
      <form class="am-form tjlanmu" action="addShoppingUser" method="post">
       ...
       <div class="am-form-group">
         ...
         <div class="am-form-group">
          ...
          <div class="you">
           邮箱 <input type="email" class="am-input-sm" id="doc-ipt-email-1" name="userEmail" placeholder="请输入邮箱">
          </div>
        </div>
          <div class="am-form-group">
      
          <div class="you">
            密码<input type="text" class="am-input-sm" id="doc-ipt-email-1" name="userPassword" placeholder="请输入密码">
          </div>
        </div>
