...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="am-form" action="addgoodsAdd?name=${name}" method="post">
        <div class="am-form-group am-cf">
          <div class="zuo">商品：</div>
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-email-1" name="goodsName" placeholder="请输入商品名称">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">商品价格：</div>
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-pwd-1" name="goodsPrice" placeholder="请输入商品价格">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">描述：</div>
          <div class="you">
          <input type="text" rows="2" id="doc-ta-1"  name="goodsmessages">
        ...
        <div class="am-form-group am-cf">
          <div class="you" style="margin-left: 11%;">
              <input type="submit" class="am-btn am-btn-success am-radius" name= "go" value="发布并关闭窗口" /> &nbsp;  &raquo; &nbsp; <input type="submit" class="am-btn am-btn-secondary am-radius" name="go" value="发布并继续发布" />
