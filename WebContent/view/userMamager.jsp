...
<div class=" admin-content">
	...
	<div class="am-popup am-popup-inner" id="my-popups-add">
      ...
      <h4 class="am-popup-title">手动添加角色</h4>
      ...
      <form class="am-form tjlanmu" action="Addrole" method="post">


       <div class="am-form-group">
        
          <div class="you">
      角色名   <input type="text" class="am-input-sm" id="doc-ipt-email-1" name="rolename" placeholder="请输入用户名">
          </div>
        </div>
         <div class="am-form-group">
       
          <div class="you">
        角色信息<input type="text" class="am-input-sm" id="doc-ipt-email-1" name="rolemesage" placeholder="请输入邮箱">
          </div>
        </div>
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl>
        <button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"   data-am-modal="{target: '#my-popups-add'}"   > 手动添加角色</button>
      </dl>
         ...
         <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-id">用户角色ID</th>
                <th class="table-title">角色名</th>
                <th class="table-author am-hide-sm-only">用户角色</th>
            ...
            <tbody>
            	...
            	<c:forEach items="${listuserrole}" var="node">
                ...
                <td> 	
                    ...
                    <div class="am-btn-group am-btn-group-xs">
                       <button class="am-btn am-btn-default am-btn-xs am-text-success am-round"><span class="am-icon-search" title="查看订单详情"></span> </button>
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" data-am-modal="{target: '#my-popups'}" title="修改订单"><span class="am-icon-pencil-square-o"></span></button>
                      <a class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除会员" href="deleteUserrole?ur_id=${node.id}"><span class="am-icon-trash-o" ></span></a>
      ...
      <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-id">角色ID</th>
                <th class="table-title">角色名称</th>
                <th class="table-author am-hide-sm-only">角色说明</th>
                <th class="table-author am-hide-sm-only">要添加本角色的用户ID</th>
                <th width="130px" class="table-set">操作</th>
              </tr>
            </thead>
            <tbody>
            	...
            	<c:forEach items="${rolelist}" var="node">
            	   <form action="userAddrole?roleID=${node.id}" method="post">
			    <tr>	
				<td><c:out value="${node.id}"></c:out></td>
				<td><c:out value="${node.rolename}"></c:out></td>
				<td><c:out value="${node.massage}"></c:out></td>
